    "id": {
        ...
        "gopay_qr_created": "💳 <b>QR GoPay siap</b>\n\nSaldo yang akan masuk: <b>{amount}</b>\nNominal yang harus dibayar: <b>{payment_amount}</b>\n\nScan QR di atas. Setelah pembayaran terdeteksi, saldo akan masuk otomatis. QR berlaku sekitar 15 menit.",
        ...
        "gopay_qr_created": "💳 <b>GoPay QR Ready</b>\n\nBalance credit: <b>{amount}</b>\nPayment amount: <b>{payment_amount}</b>\n\nScan the QR above. Your balance will be credited automatically after payment is detected. QR expires in about 15 minutes.",
